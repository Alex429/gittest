...
(function (StockChart) {
    var TrendLine = (function (_super) {
        ...
        TrendLine.prototype.drawPriceLine = function () {
            var _this = this;
            var _a = this, ctx = _a.ctx, dpr = _a.dpr, figureWidth = _a.figureWidth, figureHeight = _a.figureHeight,
                figureOffsetHeight = _a.figureOffsetHeight, figureOffsetY = _a.figureOffsetY;
            var _b = this, prices = _b.prices, preClosePrice = _b.preClosePrice, avgPrices = _b.avgPrices,
                isIndex = _b.isIndex;
            var isFlat = false;
        ...
        TrendLine.prototype.drawAxisText = function () {
            var _a = this, height = _a.height, figureWidth = _a.figureWidth, figureHeight = _a.figureHeight,
                figureOffsetHeight = _a.figureOffsetHeight, figureOffsetY = _a.figureOffsetY,
                textOffsetY = _a.textOffsetY, volumeHeight = _a.volumeHeight;
            var _b = this, roofPrice = _b.roofPrice, floorPrice = _b.floorPrice, preClosePrice = _b.preClosePrice,
                roofPercent = _b.roofPercent, floorPercent = _b.floorPercent;
            var axisY = height - volumeHeight;
        ...
        TrendLine.prototype.drawMiddleLine = function () {
            var _a = this, ctx = _a.ctx, figureWidth = _a.figureWidth, figureOffsetHeight = _a.figureOffsetHeight,
                figureOffsetY = _a.figureOffsetY;
        ...
        TrendLine.prototype.drawVolumeLine = function () {
            var _a = this, ctx = _a.ctx, volumes = _a.volumes, volumeHeight = _a.volumeHeight, height = _a.height,
                textOffsetY = _a.textOffsetY, unitX = _a.unitX;
            var maxVolume = Math.max.apply(null, volumes);
            var minVolume = Math.min.apply(null, volumes);
            var volumeUnitY = (volumeHeight - textOffsetY) / (maxVolume - minVolume);
